# Graph Report - savazai-harness  (2026-07-08)

## Corpus Check
- 182 files · ~78,896 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2507 nodes · 2568 edges · 287 communities (267 shown, 20 thin omitted)
...
2. `5. Re-render Optimization` - 16 edges
3. `getSystemConfig()` - 15 edges
4. `Better Auth Integration Guide` - 15 edges
5. `Browser Automation with playwright-cli` - 15 edges
6. `7. JavaScript Performance` - 15 edges
7. `TelemetryGateway` - 14 edges
8. `CRITICAL RULES - SAVAZAI AGENT HARNESS ENGINEERING` - 14 edges
...
Cohesion: 0.06
Nodes (32): dependencies, cors, dotenv, drizzle-orm, express, @langchain/langgraph, @langchain/langgraph-checkpoint-postgres, postgres (+24 more)
...
Cohesion: 0.19
Nodes (16): client, Db, agentSessionMemory, autonomousAgents, connectedApps, ModelConfig, skillEmbeddings, systemConfigurations (+8 more)
...
Cohesion: 0.10
Nodes (19): Better Auth Integration Guide, CLI Commands, Client, code:block1 (import { twoFactor } from "better-auth/plugins/two-factor"), Common Gotchas, Core Config Options, Database, Email Flows (+11 more)
...
Cohesion: 0.18
Nodes (11): name, notNull, primaryKey, type, app_name, mcp_endpoint_url, name, notNull (+3 more)
...
Cohesion: 0.12
Nodes (13): ChatMessage(), ChatMessageData, ChatMessageProps, AttachedFile, MODEL_OPTIONS, MODEL_PRESETS, PROVIDER_LABELS, SystemTrace() (+5 more)

### Community 172 - "Community 172"
Cohesion: 0.29
Nodes (6): Backend (.env), 🚀 Coolify Cloud VPS Deployment Guidance, Frontend (.env.local / Coolify Build Secrets), 🔐 Production Environment Variables Guide, 🛠️ Project Architecture, SavazAI Multi-Agent Operating System & Control Plane

### Community 173 - "Community 173"
Cohesion: 0.17
Nodes (21): AgentProfile, agentRoutingLogic(), buildTimestamp(), correctorNode(), detectIntent(), EPHEMERAL_AGENTS, extractDomainContext(), generateEphemeralAgent() (+13 more)

### Community 174 - "Community 174"
Cohesion: 0.33
Nodes (6): name, notNull, primaryKey, type, app_title, columns
...
Cohesion: 0.33
Nodes (6): default, name, notNull, primaryKey, type, brand_logo_url

### Community 188 - "Community 188"
Cohesion: 0.29
Nodes (4): { GET, POST }, Sidebar(), auth, pool
...
Cohesion: 0.12
Nodes (14): compiledGraph, app, broadcaster, event, gateway, input, { maskedText, tokenMap }, parsed (+6 more)
...
Cohesion: 0.06
Nodes (30): dependencies, better-auth, lucide-react, next, pg, @radix-ui/react-dialog, @radix-ui/react-dropdown-menu, @radix-ui/react-popover (+22 more)
...
Cohesion: 0.17
Nodes (13): ChatWorkspaceProps, DEFAULT_LLM_PROVIDERS, PROVIDER_LABELS, PROVIDER_MODELS, SettingsDashboardProps, TabType, LLMProviderConfig, SystemConfig (+5 more)
...
Cohesion: 0.20
Nodes (7): DaySchedule, DayScheduleSchema, distributeObjectives(), EventOrchestrator, generateId(), OrchestratedEvent, OrchestratedEventSchema
...
Cohesion: 0.18
Nodes (11): description, embedding, name, notNull, primaryKey, type, name, notNull (+3 more)
...
Cohesion: 0.16
Nodes (14): geistMono, geistSans, generateMetadata(), metadata, Home(), ChatWorkspace(), SettingsDashboard(), getSystemConfig() (+6 more)
...
Cohesion: 0.40
Nodes (5): name, notNull, primaryKey, type, bearer_token_hash
...
Cohesion: 0.20
Nodes (8): navItems, SignInForm(), SignInFormProps, SignUpForm(), SignUpFormProps, authClient, SignInPage(), SignUpPage()

### Community 261 - "Community 261"
Cohesion: 0.40
Nodes (5): skill_name, name, notNull, primaryKey, type
...
Cohesion: 0.50
Nodes (4): 1.6 Strategic Suspense Boundaries, code:tsx (async function Page() {), code:tsx (function Page() {), code:tsx (function Page() {)
...
## Knowledge Gaps
- **1550 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+1545 more)
...
- **Why does `React Best Practices` connect `Community 86` to `Community 2`, `Community 4`, `Community 70`, `Community 39`, `Community 9`, `Community 53`, `Community 59`, `Community 61`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `7. JavaScript Performance` connect `Community 70` to `Community 160`, `Community 108`, `Community 109`, `Community 83`, `Community 84`, `Community 86`, `Community 157`, `Community 280`, `Community 281`, `Community 283`, `Community 285`, `Community 158`, `Community 159`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `columns` connect `Community 30` to `Community 64`, `Community 263`, `Community 264`, `Community 209`, `Community 81`, `Community 252`?**
